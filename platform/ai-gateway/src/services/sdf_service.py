...
class SDFService:
    ...
    # Default question keys grouped by module -- used to filter AI questions
    # that duplicate what the wizard already covers.
    _DEFAULT_QUESTION_KEYS: Dict[str, list[str]] = {
        "hr": [
    ...
    _DUPLICATE_KEYWORDS: list[tuple[str, ...]] = [
    ...
    def _filter_duplicate_questions(
        ...
        for q in questions:
            ...
            is_duplicate = False
            for keyword_group in self._DUPLICATE_KEYWORDS:
