...
function buildReportsPage({ scheduledCfg, language = 'en' }) {
  ...
  const I18N = {
    ...
    focusEntityHint: t('reportsPage.focusEntityHint'),
    noSnapshots: t('reportsPage.noSnapshots'),
    noEntitySnapshots: t('reportsPage.noEntitySnapshots'),
    changesHeading: t('reportsPage.changesHeading'),
    fromTo: t('reportsPage.fromTo'),
    fieldsAvailable: t('reportsPage.fieldsAvailable'),
    added: t('reportsPage.diff.added'),
    removed: t('reportsPage.diff.removed'),
    changed: t('reportsPage.diff.changed'),
    countDelta: t('reportsPage.countDelta'),
    fieldsToCompare: t('reportsPage.fieldsToCompare'),
    noFieldsConfigured: t('reportsPage.noFieldsConfigured'),
    keepFieldsTip: t('reportsPage.keepFieldsTip'),
    changedRecordsPreview: t('reportsPage.changedRecordsPreview'),
    noChanges: t('reportsPage.table.noResults'),
    columnItem: t('reportsPage.columnItem'),
    columnId: t('reportsPage.columnId'),
    showingChanged: t('reportsPage.showingChanged'),
    changeLabel: t('reportsPage.changeLabel'),
  };
