// Plan C — wizard wiring (invoice.v3)
//
// Same questions as invoice.v2 plus two new cross-pack link toggles
// (invoice_stock_link, invoice_ap_link) gated by `condition` rules.
// invoice_stock_link uses the INVOICE_MODULE / INVENTORY_MODULE pseudo-rules
// recognized by moduleQuestionnaireService.evaluateCondition (Plan C).
const INVOICE_V3_QUESTIONS = [
  {
...
module.exports = {
  ...
  getQuestions() {
    return JSON.parse(JSON.stringify(INVOICE_V3_QUESTIONS));
  },
};
