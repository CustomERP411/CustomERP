...
SCRIPT_PATH=""
for candidate in "$HERE/seed-mock-data-sqlite.js" "$HERE/seed-mock-data-sqlite.template.js"; do
    if [ -f "$candidate" ]; then
...
if [ -z "$SCRIPT_PATH" ]; then
    ...
    echo "       CWD: $HERE"
    echo "       Looked for:"
    echo "         - $HERE/seed-mock-data-sqlite.js"
    echo "         - $HERE/seed-mock-data-sqlite.template.js"
